/*
    global Selectize
    Source : https://github.com/SLMNBJ/selectize-plugin-a11y/blob/master/selectize-plugin-a11y.js
...
Selectize.define("selectize-plugin-a11y", function (options) {
  ...
  self.accessibility.liveRegion = {
    ...
    domListener: function () {
      var observer = new MutationObserver(function (mutations) {
        mutations.forEach(function (mutation) {
          ...
          if ($target.hasClass("items")) {
            ...
            } else if($target.hasClass("dropdown-empty-message")) {
              self.accessibility.liveRegion.speak($target.text(), 500);
            }
          }
        });
      ...
      observer.observe(self.$empty_results_container[0], {
        attributes: true,
