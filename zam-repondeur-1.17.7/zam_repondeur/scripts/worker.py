...
def start_huey(
    ...
    worker_type = str(settings.get("huey.worker_type", "thread"))
    workers = int(settings.get("huey.workers", 2))
    max_delay = float(settings.get("huey.max_delay", 5.0))
    flush_locks = bool(strtobool(settings.get("huey.flush_locks", "true")))
