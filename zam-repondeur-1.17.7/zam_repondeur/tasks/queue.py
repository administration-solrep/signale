...
class TransactionalHuey(Huey):
        ...
        **kwargs: Any,
        ...
        def decorator(func):  # type: ignore
            def method_validate(self, timestamp):  # type: ignore
                ...
                timestamp = utc_timestamp.astimezone(europe_paris_tz)
    ...
    def get_url_dossier_from_ini(self, dossier_slug: str) -> str:
        base_url = self.settings.get("zam.app.url", "")
        return f"{base_url}dossiers/{dossier_slug}"
